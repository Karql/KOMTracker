...
- **Out of Phase 0/2a:** installations (parent = bike/component, positions, date windows, D-7/D-18 — Phase 2b), the install-chain mileage attribution (Phase 3), alerts (5), cost analysis (4).
