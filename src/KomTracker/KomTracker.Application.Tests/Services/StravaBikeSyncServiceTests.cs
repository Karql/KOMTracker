...
public class StravaBikeSyncServiceTests
{
    ...
    private readonly StravaBikeSyncService _service;

    public StravaBikeSyncServiceTests()
    {
        ...
        _service = new StravaBikeSyncService(_komUoW, _athleteService, _gearService);
    }
    ...
    public async Task Upserts_bikes_and_sets_bikes_enabled()
    {
        ...
        var res = await _service.SyncAthleteBikesAsync(1, CancellationToken.None);
