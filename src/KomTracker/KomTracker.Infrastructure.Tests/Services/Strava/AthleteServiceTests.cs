...
using KomTracker.Infrastructure.Services.Strava;
using KomTracker.Application.Errors.Strava.Athlete;

namespace KomTracker.Infrastructure.Tests.Services.Strava;
...
public class AthleteServiceTests
{
    ...
    public AthleteServiceTests()
    {
        ...
        _athleteService = new AthleteService(_mapper, _tokenService, _athleteApi);
    }
