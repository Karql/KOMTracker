...
public class ComponentEntityTypeConfiguration
    : IEntityTypeConfiguration<ComponentEntity>
{
    public void Configure(EntityTypeBuilder<ComponentEntity> builder)
    {
        builder.ToTable("component", "bt");
        ...
        // Current warehouse (nullable). Referenceless FK; deleting a warehouse just clears the location.
        builder.HasOne<WarehouseEntity>().WithMany().HasForeignKey(x => x.WarehouseId)
