...
namespace KomTracker.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20211111225731_AddKomsSummarySegmentEffortTable")]
    partial class AddKomsSummarySegmentEffortTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KomTracker.Domain.Entities.Segment.KomsSummaryModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("KomTracker.Domain.Entities.Segment.KomsSummarySegmentEffortModel", b =>
                {
            ...
            modelBuilder.Entity("KomTracker.Domain.Entities.Segment.KomsSummarySegmentEffortModel", b =>
                {
                    b.HasOne("KomTracker.Domain.Entities.Segment.KomsSummaryModel", null)
                        .WithMany()
                        .HasForeignKey("KomSummaryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("KomTracker.Domain.Entities.Segment.SegmentEffortModel", null)
                        .WithMany()
